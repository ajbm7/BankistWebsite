...
// //Scroll events are poor for performance!
...
// const observer = new IntersectionObserver(obsCallack, obsOptions);
...
const loadImg = function (entries, observer) {
  ...
  entry.target.addEventListener('load', function (entry) {
...
//Styles
message.style.backgroundColor = '#747a82';
...
console.log(link2.getAttribute('src'));
